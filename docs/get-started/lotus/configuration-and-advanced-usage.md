...
- Open a port in your router that is forwarded to this port. This is usually called featured as "端口转发" and the instructions differ from router model to model but there are many guides online.
